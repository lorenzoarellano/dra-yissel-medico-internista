<template>
  ...
  >
    ...
    <!-- Pulse ring inner -->
    <span class="absolute inline-flex h-[calc(100%+12px)] w-[calc(100%+12px)] rounded-full border-2 border-[#25D366]/40 animate-pulse"></span>
    <!-- WhatsApp SVG icon -->
    <svg class="relative z-10 w-8 h-8" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
