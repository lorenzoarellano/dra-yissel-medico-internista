import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, getResponseStatus, removeResponseHeader, createError, appendResponseHeader, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withoutTrailingSlash, hasProtocol, withHttps, withoutProtocol, withTrailingSlash, withLeadingSlash, withBase, joinRelativeURL, decodePath, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/ufo/dist/index.mjs';
import destr from 'file://C:/projects/dra-yissel-medico-internista/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/node-mock-http/dist/index.mjs';
import { klona } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/scule/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/vue/index.mjs';
import { createConsola, consola } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/consola/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1, basename, isAbsolute } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/@iconify/utils/lib/index.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/ipx/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/projects/dra-yissel-medico-internista/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47C_58_47projects_47dra_45yissel_45medico_45internista_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js from 'file:///C:/projects/dra-yissel-medico-internista/node_modules/nuxt/dist/core/runtime/nitro/cache-driver.js';
import unstorage_47drivers_47fs_45lite from 'file://C:/projects/dra-yissel-medico-internista/node_modules/unstorage/drivers/fs-lite.mjs';
import { digest } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/nitropack/node_modules/ohash/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/projects/dra-yissel-medico-internista/server/assets"}];
...
storage.mount('internal:nuxt:prerender', file_58_47_47_47C_58_47projects_47dra_45yissel_45medico_45internista_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js({"driver":"file:///C:/projects/dra-yissel-medico-internista/node_modules/nuxt/dist/core/runtime/nitro/cache-driver.js","base":"C:/projects/dra-yissel-medico-internista/.nuxt/cache/nitro/prerender"}));
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/projects/dra-yissel-medico-internista"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/projects/dra-yissel-medico-internista/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/projects/dra-yissel-medico-internista/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/projects/dra-yissel-medico-internista/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
    ...
    "stack": [
      {
        "_context": "system",
        "_priority": -15,
        "name": "dra-yissel-medico-internista",
        "env": "production"
      },
      {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/projects/dra-yissel-medico-internista/public"
      ]
    },
    "http": {
      "domains": []
...
const _Vou69OpfS2yXJNVYWuSOzrA7_wbBZujHQDzM9aKP55w = defineNitroPlugin(async (nitroApp) => {
...
const _q77tc23oo_BAgNx8LZoBIRga4ov68Ou5dYtrVHp0W4 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _Vou69OpfS2yXJNVYWuSOzrA7_wbBZujHQDzM9aKP55w,
_q77tc23oo_BAgNx8LZoBIRga4ov68Ou5dYtrVHp0W4
];
...
const _hW3kJB = eventHandler((event) => {
...
const _Suemwf = defineEventHandler(async (e) => {
...
const _u4ntaj = defineEventHandler(async (e) => {
...
const _dMoZIc = defineEventHandler(async (e) => {
...
const _knL1wA = defineEventHandler(async (e) => {
...
const _Zsdh5v = defineEventHandler(async (e) => {
...
const _p6nBSE = defineCachedEventHandler(async (ctx) => {
...
const _WurjEe = lazyEventHandler(() => {
...
const _lazy_TETcK7 = () => import('./renderer.mjs');

const handlers = [
  { route: '', handler: _hW3kJB, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _Suemwf, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _u4ntaj, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _dMoZIc, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _knL1wA, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Zsdh5v, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _p6nBSE, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _WurjEe, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TETcK7, lazy: true, middleware: false, method: undefined }
];
