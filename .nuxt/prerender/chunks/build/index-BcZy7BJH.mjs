...
import { defineComponent, mergeProps, ref, useSSRContext } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderClass } from 'file://C:/projects/dra-yissel-medico-internista/node_modules/vue/server-renderer/index.mjs';
import { u as useHead, _ as _imports_0$1, a as _imports_1, b as _imports_2 } from './server.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><span class="text-sm font-medium text-slate-700">Atenci\xF3n personalizada</span></div><div class="flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-full px-4 py-2 shadow-sm"><span class="flex items-center justify-center w-7 h-7 rounded-full bg-accent/15">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:stethoscope",
        class: "w-3.5 h-3.5 text-accent"
      }, null, _parent));
      _push(`</span><span class="text-sm font-medium text-slate-700">Diagn\xF3stico especializado</span></div><div class="flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-full px-4 py-2 shadow-sm"><span class="flex items-center justify-center w-7 h-7 rounded-full" style="${ssrRenderStyle({ "background": "rgba(240,170,36,0.15)" })}">`);
      _push(ssrRenderComponent(_component_Icon, {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><p class="text-[10px] font-medium text-slate-500 uppercase tracking-wider leading-none mb-0.5">Certificada por el</p><p class="text-xs font-bold text-slate-900 leading-none">Consejo M\xE9dico</p></div></div></div></div><div class="a-text space-y-6"><h3 class="text-2xl font-bold text-slate-800">Perfil Profesional</h3><ul class="space-y-4"><li class="a-li flex items-start opacity-0"><div class="flex-shrink-0 mt-1">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:check-circle-2",
        class: "w-5 h-5 text-accent"
      }, null, _parent));
      _push(`</div><p class="ml-3 text-slate-600"> Licenciatura como <strong>M\xE9dico, Cirujano y Partero</strong> por la Universidad de Guadalajara \u2014 una de las escuelas de medicina de mayor prestigio en M\xE9xico. </p></li><li class="a-li flex items-start opacity-0"><div class="flex-shrink-0 mt-1">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:check-circle-2",
        class: "w-5 h-5 text-accent"
      }, null, _parent));
      _push(`</div><p class="ml-3 text-slate-600"><strong>Especialidad en Medicina Interna</strong> por la Universidad de Guadalajara en el Centro M\xE9dico Nacional de Occidente (IMSS), con enfoque en patolog\xEDa cr\xF3nica del adulto. </p></li><li class="a-li flex items-start opacity-0"><div class="flex-shrink-0 mt-1">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:check-circle-2",
        class: "w-5 h-5 text-accent"
      }, null, _parent));
      _push(`</div><p class="ml-3 text-slate-600"><strong>Consultas especializadas</strong> realizadas en Aguascalientes, con resultados documentados en control metab\xF3lico y cardiovascular. </p></li><li class="a-li flex items-start opacity-0"><div class="flex-shrink-0 mt-1">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:award",
        class: "w-5 h-5 text-accent"
      }, null, _parent));
      _push(`</div><p class="ml-3 text-slate-600"> Certificada vigente por el <strong>Consejo Mexicano de Medicina Interna (CMMI)</strong>, garant\xEDa de actualizaci\xF3n continua y est\xE1ndares de excelencia cl\xEDnica. </p></li></ul><div class="pt-6 border-t border-slate-200 flex flex-wrap gap-3"><div class="glass px-4 py-2 rounded-lg inline-flex items-center space-x-2">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:file-text",
        class: "w-4 h-4 text-primary"
      }, null, _parent));
      _push(`<span class="text-sm font-medium text-slate-700">C\xE9dula Prof: <strong>12193559</strong></span></div><div class="glass px-4 py-2 rounded-lg inline-flex items-center space-x-2">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:file-badge",
        class: "w-4 h-4 text-primary"
      }, null, _parent));
      _push(`<span class="text-sm font-medium text-slate-700">C\xE9dula Esp: <strong>14201115</strong></span></div><div class="inline-flex items-center space-x-2 px-4 py-2 rounded-lg text-white text-sm font-semibold" style="${ssrRenderStyle({ "background": "linear-gradient(135deg,#132f57 0%,#1a6fa0 55%,#2ebd85 100%)" })}">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:award",
        class: "w-4 h-4"
      }, null, _parent));
    ...
    const services = [
      {
        ...
        title: "Control de enfermedades cr\xF3nicas",
        description: "Tratamiento integral y seguimiento puntual de <strong>diabetes mellitus</strong>, <strong>hipertensi\xF3n arterial sist\xE9mica</strong>, enfermedad renal cr\xF3nica, EPOC y otras patolog\xEDas de larga evoluci\xF3n, buscando la estabilizaci\xF3n metab\xF3lica y la mejor calidad de vida."
      },
      {
        icon: "lucide:heart-pulse",
        title: "Trastornos endocrinol\xF3gicos y cardiovasculares",
        description: "Abordaje experto de <strong>dislipidemias</strong>, <strong>hipotiroidismo e hipertiroidismo</strong>, insuficiencia suprarrenal, arritmias, insuficiencia cardiaca y patolog\xEDas hematol\xF3gicas, con protocolos cl\xEDnicos basados en evidencia."
      },
      {
        icon: "lucide:shield-plus",
        title: "Medicina preventiva y valoraci\xF3n prequir\xFArgica",
        description: "<strong>Chequeo m\xE9dico preventivo</strong> completo, tamizaje oportuno de enfermedades silenciosas como diabetes y hipertensi\xF3n, y <strong>valoraci\xF3n preoperatoria</strong> certificada de alta precisi\xF3n para cirug\xEDas electivas."
      },
      {
        icon: "lucide:stethoscope",
        title: "Diagn\xF3stico complejo y segunda opini\xF3n",
        description: "Evaluaci\xF3n cl\xEDnica detallada de <strong>s\xEDndromes de dif\xEDcil diagn\xF3stico</strong>, manejo integral de <strong>obesidad m\xF3rbida</strong>, enfermedades autoinmunes y <strong>segundas opiniones m\xE9dicas</strong> respaldadas por criterios actualizados."
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      ...
      ssrRenderList(services, (service, i) => {
        ...
        _push(`</div><h3 class="text-2xl font-bold text-slate-800 mb-4">${ssrInterpolate(service.title)}</h3><p class="text-slate-600 leading-relaxed text-justify">${(_a = service.description) != null ? _a : ""}</p></div>`);
      });
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const testimonials = [
      {
        name: "Mar\xEDa Elena Gonz\xE1lez",
        location: "Col. Insurgentes",
        color: "#2ebd85",
        text: '"Llevaba a\xF1os con la diabetes descontrolada y sin una explicaci\xF3n clara de mi padecimiento. La Dra. Yissel me dedic\xF3 el tiempo que necesitaba, me explic\xF3 todo con paciencia y hoy mi glucosa est\xE1 perfectamente controlada. Una doctora extraordinaria y de gran calidad humana."'
      },
      {
        name: "Roberto Mart\xEDnez \xC1valos",
        location: "Col. Ojocaliente",
        color: "#3b82f6",
        text: '"Llegu\xE9 con hipertensi\xF3n severa y mucha preocupaci\xF3n. Desde la primera consulta me transmiti\xF3 confianza y profesionalismo. Su tratamiento fue preciso y en pocas semanas mis cifras mejoraron notablemente. La recomiendo ampliamente con toda mi familia."'
      },
      {
        name: "Laura Hern\xE1ndez de Lira",
        location: "Fracc. Jardines de la Asunci\xF3n",
        color: "#f0aa24",
        text: '"Me hice un chequeo preventivo y fue la mejor decisi\xF3n de mi vida. Detect\xF3 a tiempo un problema tiroideo que yo ignoraba por completo. Su criterio cl\xEDnico y trato humano son excepcionales. Le debo mucho a la Dra. Yissel."'
      },
      {
        name: "Carlos Aguirre R\xEDos",
        location: "Col. Morelos",
        color: "#e85d75",
        text: '"Necesitaba una valoraci\xF3n preoperatoria urgente y me atendieron con rapidez y gran profesionalismo. El reporte fue muy completo y el cirujano qued\xF3 muy satisfecho. Sin duda la mejor internista con la que he tenido la fortuna de consultar en Aguascalientes."'
      },
      {
        name: "Gabriela Delgado Mu\xF1oz",
        location: "Col. Primo Verdad",
        color: "#a855f7",
        text: '"Busqu\xE9 una segunda opini\xF3n sobre un diagn\xF3stico que me hab\xEDan dado y la Dra. Yissel me brind\xF3 claridad total y mucha tranquilidad. Su conocimiento es impresionante y su calidez humana, invaluable. Ya toda mi familia es paciente suya."'
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      ...
      _push(`<!--]--></div><span class="whitespace-nowrap">Deja tu rese\xF1a en Google</span>`);
      _push(ssrRenderComponent(_component_Icon, {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const faqs = [
      {
        question: "\xBFQu\xE9 es un m\xE9dico internista y en qu\xE9 se diferencia de un m\xE9dico general?",
        answer: "Un <strong>m\xE9dico internista</strong> es especialista en el diagn\xF3stico y tratamiento no quir\xFArgico de enfermedades que afectan los \xF3rganos internos del adulto, especialmente padecimientos cr\xF3nicos y complejos (diabetes, hipertensi\xF3n, enfermedades renales, endocrinol\xF3gicas, hematol\xF3gicas). A diferencia del m\xE9dico general, el internista tiene 3 a\xF1os adicionales de formaci\xF3n hospitalaria de alta complejidad y est\xE1 certificado por un consejo oficial para manejar casos de mayor profundidad cl\xEDnica."
      },
      {
        question: "\xBFC\xF3mo llego exactamente al consultorio de la Dra. Yissel Mendoza?",
        answer: "El consultorio se encuentra dentro del <strong>Hospital MAC SUR, Torre C, Consultorio 201</strong>, en Blvrd. Rep\xFAblica de Per\xFA 102, Aguascalientes, Ags. C.P. 20234. Al llegar al hospital, dir\xEDgete a la Torre C o al \xE1rea de Centro Oncol\xF3gico y sube al nivel 2. Cuenta con estacionamiento propio y transporte p\xFAblico cercano."
      },
      {
        question: "\xBFQu\xE9 padecimientos trata un m\xE9dico internista en Aguascalientes?",
        answer: "La Dra. Yissel Mendoza trata un amplio espectro de padecimientos: <strong>diabetes mellitus tipo 1 y tipo 2</strong>, hipertensi\xF3n arterial, dislipidemias, enfermedad renal cr\xF3nica, hipotiroidismo, hipertiroidismo, anemia, enfermedades pulmonares cr\xF3nicas (EPOC, asma del adulto), enfermedades autoinmunes, obesidad m\xF3rbida y muchas otras patolog\xEDas internas del adulto."
      },
      {
        question: "\xBFNecesito referencia m\xE9dica para consultar con la Dra. Yissel?",
        answer: 'No, <strong>no es necesaria una referencia m\xE9dica previa</strong> para agendar tu consulta. Puedes llamar directamente al <a href="tel:4494970240" class="text-primary font-bold hover:underline">449-497-02-40</a> o contactar por WhatsApp para programar tu cita. Sin embargo, si tu m\xE9dico general ya te realiz\xF3 estudios, es recomendable llevarlos para optimizar la consulta.'
      },
      {
        question: "\xBFCu\xE1nto tiempo dura una consulta de medicina interna?",
        answer: "Una primera consulta dura aproximadamente <strong>40 a 60 minutos</strong>, ya que implica historia cl\xEDnica completa, revisi\xF3n de estudios previos, exploraci\xF3n f\xEDsica y plan diagn\xF3stico-terap\xE9utico integral. Las consultas de seguimiento duran entre 20 y 30 minutos para evaluar evoluci\xF3n y ajustar tratamiento."
      },
      {
        question: "\xBFQu\xE9 debo llevar a mi primera consulta?",
        answer: "Para aprovechar al m\xE1ximo tu primera consulta, te recomendamos traer: <strong>identificaci\xF3n oficial</strong>, estudios de laboratorio recientes (si tienes), lista de medicamentos que tomas actualmente, historial m\xE9dico relevante y, en caso de alguna enfermedad espec\xEDfica, cualquier diagn\xF3stico previo por escrito. No es indispensable, pero agiliza el proceso."
      },
      {
        question: "\xBFLa Dra. Yissel Mendoza trabaja con seguros m\xE9dicos o planes de salud?",
        answer: 'Para consultar la aceptaci\xF3n de tu seguro m\xE9dico o plan de salud espec\xEDfico, te invitamos a comunicarte directamente al <a href="tel:4494970240" class="text-primary font-bold hover:underline">449-497-02-40</a> antes de tu cita. El pago particular tambi\xE9n est\xE1 disponible, garantizando atenci\xF3n \xE1gil sin tiempos de espera prolongados.'
      },
      {
        question: "\xBFAtiende pacientes pedi\xE1tricos o adolescentes?",
        answer: "La Medicina Interna se especializa exclusivamente en la atenci\xF3n integral de pacientes <strong>adultos (mayores de 18 a\xF1os)</strong>. Para ni\xF1os y adolescentes, lo ideal es acudir con un m\xE9dico pediatra. Sin embargo, en casos de adolescentes con enfermedades cr\xF3nicas complejas, puede evaluarse la pertinencia de una consulta."
      },
      {
        question: "\xBFTrata enfermedades autoinmunes o reumatol\xF3gicas?",
        answer: "S\xED, el m\xE9dico internista es el especialista primario para el abordaje de <strong>enfermedades autoinmunes sist\xE9micas</strong> como lupus eritematoso, artritis reumatoide, vasculitis, sarcoidosis y otras. En Aguascalientes, la Dra. Yissel Mendoza realiza la evaluaci\xF3n cl\xEDnica completa y, cuando se requiere, contin\xFAa el manejo coordinado con otros especialistas."
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      ...
      ssrRenderList(faqs, (faq, index) => {
        ...
        _push(`</div></button><div style="${ssrRenderStyle(activeIndex.value === index ? null : { display: "none" })}" class="px-6 pb-6 text-slate-600 leading-relaxed origin-top"><div class="pt-2 border-t border-slate-100"><p>${(_a = faq.answer) != null ? _a : ""}</p></div></div></div>`);
      });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes | Consulta Especializada",
      meta: [
        { name: "description", content: "Dra. Rosalba Yissel Mendoza Gonz\xE1lez, M\xE9dico Internista certificada en Aguascalientes. Especialista en diabetes, hipertensi\xF3n, enfermedades cr\xF3nicas del adulto, valoraci\xF3n prequir\xFArgica y segunda opini\xF3n m\xE9dica. Hospital MAC SUR, Torre C, Consultorio 201. Tel: 449-497-02-40." },
        ...
        { property: "og:title", content: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes" },
        { property: "og:description", content: "Especialista en Medicina Interna en Aguascalientes. Diagn\xF3stico y tratamiento de diabetes, hipertensi\xF3n, padecimientos cr\xF3nicos del adulto. C\xE9dula 12193559. Hospital MAC SUR." },
        { property: "og:type", content: "website" },
        { property: "og:image", content: "https://internistaenaguascalientes.com/social-share-cover.jpg" },
        { property: "og:image:width", content: "1200" },
        { property: "og:image:height", content: "630" },
        { property: "og:image:alt", content: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes" },
        ...
        { name: "twitter:title", content: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes" },
        { name: "twitter:description", content: "Especialista en Medicina Interna en Aguascalientes. Diagn\xF3stico y tratamiento de diabetes, hipertensi\xF3n, padecimientos cr\xF3nicos del adulto." },
        { name: "geo.region", content: "MX-AGU" },
        { name: "geo.placename", content: "Aguascalientes, M\xE9xico" },
      ...
      script: [
        {
          ...
          innerHTML: JSON.stringify({
            ...
            name: "Dra. Rosalba Yissel Mendoza Gonz\xE1lez",
            givenName: "Rosalba Yissel",
            familyName: "Mendoza Gonz\xE1lez",
            honorificPrefix: "Dra.",
            alternateName: ["Dra. Yissel Mendoza", "Dra. Yissel Mendoza Gonz\xE1lez", "Internista Aguascalientes"],
            image: [
            ...
            alumniOf: [
              ...
              { "@type": "Hospital", name: "Centro M\xE9dico Nacional de Occidente IMSS", "@id": "https://www.wikidata.org/wiki/Q4937718" }
            ],
            sameAs: [
            ...
            description: "M\xE9dico Internista certificada en Aguascalientes, especializada en diabetes, hipertensi\xF3n, enfermedades cr\xF3nicas del adulto, valoraci\xF3n preoperatoria y diagn\xF3stico de patolog\xEDas complejas. Ofrece consulta presencial en Hospital MAC SUR y consulta virtual por videollamada.",
            medicalSpecialty: "Medicina Interna",
            url: "https://internistaenaguascalientes.com",
            telephone: "+524494970240",
            address: {
              "@type": "PostalAddress",
              streetAddress: "Blvrd. Rep\xFAblica de Per\xFA 102, Torre C, Consultorio 201",
            ...
            worksFor: {
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress: "Blvrd. Rep\xFAblica de Per\xFA 102",
                addressLocality: "Aguascalientes",
                addressRegion: "Aguascalientes",
                postalCode: "20234",
                addressCountry: "MX"
            ...
            hasCredential: [
              { "@type": "EducationalOccupationalCredential", credentialCategory: "C\xE9dula Profesional", identifier: "12193559" },
              { "@type": "EducationalOccupationalCredential", credentialCategory: "C\xE9dula de Especialidad", identifier: "14201115" }
            ],
            memberOf: {
              "@type": "MedicalOrganization",
            ...
            knowsAbout: [
              ...
              { "@type": "MedicalCondition", name: "Hipertensi\xF3n arterial", "@id": "https://www.wikidata.org/wiki/Q178523" },
              { "@type": "MedicalSpecialty", name: "Medicina Interna", "@id": "https://www.wikidata.org/wiki/Q81938" },
              { "@type": "MedicalCondition", name: "Enfermedades cr\xF3nicas del adulto" },
              { "@type": "MedicalProcedure", name: "Valoraci\xF3n preoperatoria" },
              { "@type": "MedicalCondition", name: "Enfermedad renal cr\xF3nica", "@id": "https://www.wikidata.org/wiki/Q373106" },
              ...
              { "@type": "MedicalProcedure", name: "Segunda opini\xF3n m\xE9dica" },
              { "@type": "MedicalCondition", name: "Enfermedades autoinmunes", "@id": "https://www.wikidata.org/wiki/Q18123741" }
            ],
            areaServed: {
              "@type": "City",
              name: "Aguascalientes",
              containedInPlace: { "@type": "State", name: "Aguascalientes", containedInPlace: { "@type": "Country", name: "M\xE9xico" } }
            },
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            url: "https://internistaenaguascalientes.com",
            name: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes",
            description: "Sitio oficial de la Dra. Rosalba Yissel Mendoza Gonz\xE1lez, M\xE9dico Internista certificada en Aguascalientes. Especialista en diabetes, hipertensi\xF3n, valoraci\xF3n peroperatoria y enfermedades cr\xF3nicas del adulto.",
            inLanguage: "es-MX",
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "\xBFQu\xE9 es un m\xE9dico internista y en qu\xE9 se diferencia de un m\xE9dico general?",
                acceptedAnswer: { "@type": "Answer", text: "Un m\xE9dico internista es especialista en el diagn\xF3stico y tratamiento no quir\xF3rgico de enfermedades que afectan los \xF3rganos internos del adulto, especialmente padecimientos cr\xF3nicos y complejos (diabetes, hipertensi\xF3n, enfermedades renales, endocrinol\xF3gicas, hematol\xF3gicas). A diferencia del m\xE9dico general, el internista tiene 3 a\xF1os adicionales de formaci\xF3n hospitalaria de alta complejidad y est\xE1 certificado por un consejo oficial." }
              },
              {
                "@type": "Question",
                name: "\xBFC\xF3mo llego exactamente al consultorio de la Dra. Yissel Mendoza?",
                acceptedAnswer: { "@type": "Answer", text: "El consultorio se encuentra dentro del Hospital MAC SUR, Torre C, Consultorio 201, en Blvrd. Rep\xFAblica de Per\xFA 102, Aguascalientes, Ags. C.P. 20234. Al llegar al hospital, dir\xEDgete a la Torre C o al \xE1rea de Centro Oncol\xF3gico y sube al nivel 2. Cuenta con estacionamiento propio y transporte p\xFAblico cercano." }
              },
              {
                "@type": "Question",
                name: "\xBFQu\xE9 padecimientos trata un m\xE9dico internista en Aguascalientes?",
                acceptedAnswer: { "@type": "Answer", text: "La Dra. Yissel Mendoza trata: diabetes mellitus tipo 1 y tipo 2, hipertensi\xF3n arterial, dislipidemias, enfermedad renal cr\xF3nica, hipotiroidismo, hipertiroidismo, anemia, enfermedades pulmonares cr\xF3nicas (EPOC, asma del adulto), enfermedades autoinmunes, obesidad m\xF3rbida y otras patolog\xEDas internas del adulto." }
              },
              {
                "@type": "Question",
                name: "\xBFNecesito referencia m\xE9dica para consultar con la Dra. Yissel?",
                acceptedAnswer: { "@type": "Answer", text: "No es necesaria una referencia m\xE9dica previa. Puedes llamar directamente al 449-497-02-40 o contactar por WhatsApp para programar tu cita." }
              },
              {
                "@type": "Question",
                name: "\xBFCu\xE1nto tiempo dura una consulta de medicina interna?",
                acceptedAnswer: { "@type": "Answer", text: "Una primera consulta dura aproximadamente 40 a 60 minutos. Las consultas de seguimiento duran entre 20 y 30 minutos para evaluar evoluci\xF3n y ajustar tratamiento." }
              },
              {
                "@type": "Question",
                name: "\xBFQu\xE9 debo llevar a mi primera consulta?",
                acceptedAnswer: { "@type": "Answer", text: "Te recomendamos traer: identificaci\xF3n oficial, estudios de laboratorio recientes, lista de medicamentos actuales, historial m\xE9dico relevante y cualquier diagn\xF3stico previo por escrito." }
              },
              {
                "@type": "Question",
                name: "\xBFLa Dra. Yissel Mendoza trabaja con seguros m\xE9dicos o planes de salud?",
                acceptedAnswer: { "@type": "Answer", text: "Para consultar la aceptaci\xF3n de tu seguro m\xE9dico espec\xEDfico, comun\xEDcate directamente al 449-497-02-40 antes de tu cita. El pago particular tambi\xE9n est\xE1 disponible." }
              },
              {
                "@type": "Question",
                name: "\xBFAtiende pacientes pedi\xE1tricos o adolescentes?",
                acceptedAnswer: { "@type": "Answer", text: "La Medicina Interna se especializa exclusivamente en la atenci\xF3n integral de pacientes adultos (mayores de 18 a\xF1os). Para ni\xF1os y adolescentes, lo ideal es acudir con un m\xE9dico pediatra." }
              },
              {
                "@type": "Question",
                name: "\xBFTrata enfermedades autoinmunes o reumatol\xF3gicas?",
                acceptedAnswer: { "@type": "Answer", text: "S\xED, el m\xE9dico internista es el especialista primario para enfermedades autoinmunes sist\xE9micas como lupus eritematoso, artritis reumatoide, vasculitis y sarcoidosis. La Dra. Yissel Mendoza realiza la evaluaci\xF3n cl\xEDnica completa en Aguascalientes." }
              }
            ]
          })
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            name: "Consultorio Dra. Yissel Mendoza \u2014 M\xE9dico Internista Aguascalientes",
            ...
            availableService: [
              {
                ...
                description: "Consulta m\xE9dica especializada en Aguascalientes, Hospital MAC SUR, Torre C, Consultorio 201.",
                serviceLocation: {
                  "@type": "MedicalClinic",
                  name: "Hospital MAC SUR Aguascalientes",
                  address: { "@type": "PostalAddress", streetAddress: "Blvrd. Rep\xFAblica de Per\xFA 102, Torre C, Consultorio 201", addressLocality: "Aguascalientes", addressCountry: "MX" }
                }
              },
              {
                "@type": "MedicalTherapy",
                name: "Consulta virtual de Medicina Interna",
                description: "Consulta m\xE9dica por videollamada con la Dra. Yissel Mendoza. Ideal para seguimiento, revisi\xF3n de estudios y segunda opini\xF3n desde cualquier lugar.",
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "HowTo",
            name: "C\xF3mo agendar una cita con la Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes",
            ...
            step: [
              {
                "@type": "HowToStep",
                position: 1,
                name: "Elige tu v\xEDa de contacto",
                text: "Llama al 449-497-02-40 o escr\xEDbenos por WhatsApp para consultar disponibilidad de citas."
              },
              {
                "@type": "HowToStep",
                position: 2,
                name: "Selecciona fecha y hora",
                text: "Escoge una fecha de lunes a s\xE1bado entre las 9:00 y las 14:00 hrs en el Hospital MAC SUR, Torre C, Consultorio 201, Aguascalientes."
              },
              {
                "@type": "HowToStep",
                position: 3,
                name: "Confirma tu cita",
                text: "Recibe confirmaci\xF3n por tel\xE9fono o WhatsApp. Anota la fecha, hora y cualquier instrucci\xF3n especial."
              },
              {
                "@type": "HowToStep",
                position: 4,
                name: "Pres\xE9ntate el d\xEDa de tu consulta",
                text: "Acude al Hospital MAC SUR (dentro del Centro Oncol\xF3gico), Torre C, Consultorio 201. Trae identificaci\xF3n oficial, estudios de laboratorio o imagen recientes y lista de medicamentos actuales."
              }
            ]
          })
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            url: "https://internistaenaguascalientes.com",
            name: "Dra. Yissel Mendoza \u2014 M\xE9dico Internista en Aguascalientes",
            description: "Sitio oficial de la Dra. Rosalba Yissel Mendoza Gonz\xE1lez, M\xE9dico Internista certificada en Aguascalientes. Especialista en diabetes, hipertensi\xF3n, valoraci\xF3n preoperatoria y enfermedades cr\xF3nicas del adulto.",
            inLanguage: "es-MX",
            ...
            medicalAudience: {
              ...
              healthCondition: { "@type": "MedicalCondition", name: "Enfermedades cr\xF3nicas del adulto" }
            },
            ...
            itemListElement: [
              {
                "@type": "ListItem",
                position: 1,
                name: "M\xE9dico Internista en Aguascalientes \u2014 Dra. Yissel Mendoza",
...
//# sourceMappingURL=index-BcZy7BJH.mjs.map
