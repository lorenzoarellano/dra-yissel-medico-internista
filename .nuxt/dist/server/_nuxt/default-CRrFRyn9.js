import { _ as __nuxt_component_0 } from "./nuxt-link-D1Yu4fn6.js";
import { defineComponent, ref, resolveComponent, mergeProps, withCtx, createVNode, useSSRContext, computed } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderTeleport, ssrRenderSlot } from "vue/server-renderer";
import "ufo";
import "hookable";
import "../server.mjs";
import "ofetch";
...
import "defu";
import "klona";
const _imports_0 = "" + __buildAssetsURL("logo.DjfCBo3g.webp");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = resolveComponent("Icon");
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8" }, _attrs))}><div class="container mx-auto px-4"><div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12"><div class="space-y-4"><img${ssrRenderAttr("src", _imports_0)} alt="Dra. Yissel Mendoza Logo" class="h-12 w-auto"><p class="text-sm text-slate-600 dark:text-slate-400"> Especializada en el abordaje y tratamiento de las enfermedades crónicas del adulto con información actualizada, integral y con calidad humana. </p><div class="flex space-x-4 pt-2"><a href="#" class="text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors" aria-label="Facebook">`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(`<a href="tel:4494970240" class="hover:text-primary dark:hover:text-secondary transition-colors">449-497-02-40</a></li></ul></div><div><h3 class="font-display font-semibold text-slate-900 dark:text-white mb-4">Legales</h3><ul class="space-y-3"><li><button class="text-sm text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-left"> Política de Privacidad </button></li><li><button class="text-sm text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-left"> Términos y Condiciones </button></li><li><button class="text-sm text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-left"> Aviso de Cookies </button></li></ul></div></div><div class="border-t border-slate-200 dark:border-slate-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500 dark:text-slate-400"><p>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Dra. Yissel Mendoza. Todos los derechos reservados.</p><p class="mt-4 md:mt-0 flex items-center"> Created by <a href="https://doctordigital.mx/" target="_blank" rel="noopener noreferrer" class="font-medium text-primary dark:text-secondary hover:underline ml-1">👾DoctorDigitalMx</a></p></div></div>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (activeModal.value) {
          ...
          if (activeModal.value === "privacy") {
            _push2(`<p>Información detallada sobre el tratamiento de sus datos personales. (Texto a completar por el área legal conforme a las leyes de México).</p>`);
          } else {
            _push2(`<!---->`);
          }
          if (activeModal.value === "terms") {
            _push2(`<p>Términos y condiciones del uso del sitio web y servicios médicos prestados por la Dra. Yissel Mendoza.</p>`);
          } else {
            _push2(`<!---->`);
          }
          if (activeModal.value === "cookies") {
            _push2(`<p>Utilizamos cookies técnicas necesarias y cookies analíticas para mejorar su experiencia. Al navegar consiente su uso.</p>`);
          } else {
            _push2(`<!---->`);
          }
...
//# sourceMappingURL=default-CRrFRyn9.js.map
