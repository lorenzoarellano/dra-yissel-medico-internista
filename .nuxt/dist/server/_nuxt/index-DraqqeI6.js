import __nuxt_component_0 from "./index-CPt6RJet.js";
...
import { _ as _imports_0$1, a as _imports_1, b as _imports_2 } from "./virtual_public-CU7Ca0pw.js";
import { publicAssetsURL } from "#internal/nuxt/paths";
import "hookable";
import "../server.mjs";
import { u as useHead } from "./vue.-sixQ7xP-CKDGYxdd.js";
import "@iconify/vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(services, (service, i) => {
        ...
        _push(`</div><h3 class="text-2xl font-bold text-slate-800 mb-4">${ssrInterpolate(service.title)}</h3><p class="text-slate-600 leading-relaxed">${service.description ?? ""}</p></div>`);
      });
...
//# sourceMappingURL=index-DraqqeI6.js.map
