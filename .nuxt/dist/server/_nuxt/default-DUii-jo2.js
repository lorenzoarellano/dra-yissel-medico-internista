import { _ as __nuxt_component_0 } from "./nuxt-link-BrfZCCrx.js";
import __nuxt_component_0$1 from "./index-CPt6RJet.js";
import { defineComponent, ref, mergeProps, withCtx, createVNode, useSSRContext, computed } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrRenderTeleport, ssrRenderSlot } from "vue/server-renderer";
import { _ as _imports_0, a as _imports_1, b as _imports_2 } from "./virtual_public-CU7Ca0pw.js";
import "ufo";
import "hookable";
import "../server.mjs";
import "ofetch";
...
import "./vue.-sixQ7xP-CKDGYxdd.js";
const _imports_3 = "" + __buildAssetsURL("logo.DjfCBo3g.webp");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span>Lun – Sáb: <strong>9:00 – 14:00 hrs</strong><br><span class="text-slate-400">Domingo: Cerrado</span></span></li><li class="flex items-start space-x-3 text-sm">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:video",
        class: "w-5 h-5 flex-shrink-0 mt-0.5",
        style: { "color": "#2ebd85" }
      }, null, _parent));
      _push(`<a href="https://wa.me/5214494970240?text=Hola%2C%20me%20gustar%C3%ADa%20agendar%20una%20consulta%20virtual%20con%20la%20Dra.%20Yissel%20Mendoza." target="_blank" rel="noopener noreferrer" class="font-semibold transition-colors hover:opacity-80" style="${ssrRenderStyle({ "color": "#1fa870" })}">Consulta virtual disponible</a></li></ul></div><div><h3 class="font-display font-semibold text-slate-900 mb-4">Legales</h3><ul class="space-y-3"><li><button class="text-sm text-slate-600 hover:text-primary transition-colors text-left"> Política de Privacidad </button></li><li><button class="text-sm text-slate-600 hover:text-primary transition-colors text-left"> Términos y Condiciones </button></li><li><button class="text-sm text-slate-600 hover:text-primary transition-colors text-left"> Aviso de Cookies </button></li></ul></div></div><div class="border-t border-slate-200 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500"><p>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Dra. Yissel Mendoza. Todos los derechos reservados.</p><p class="mt-4 md:mt-0 flex items-center"> Created by <a href="https://doctordigital.mx/" target="_blank" rel="noopener noreferrer" class="font-medium text-primary hover:underline ml-1">👾DoctorDigitalMx</a></p></div></div>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (activeModal.value) {
          ...
          if (activeModal.value === "privacy") {
            _push2(`<div><p class="text-slate-500 text-xs mb-4">Última actualización: febrero 2026 • Conforme a la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) y su Reglamento, México.</p><h3>1. Responsable del tratamiento</h3><p>La Dra. Rosalba Yissel Mendoza González, con consultorio ubicado en Blvrd. República de Perú 102, Torre C, Consultorio 201, Aguascalientes, Ags., C.P. 20234 (en adelante &quot;la Responsable&quot;), es la entidad responsable del tratamiento de sus datos personales.</p><h3>2. Datos personales recabados</h3><p>Para la prestación de servicios médicos y de contacto, podemos recabar los siguientes datos:</p><ul><li><strong>Datos de identificación:</strong> nombre completo, fecha de nacimiento, CURP.</li><li><strong>Datos de contacto:</strong> número de teléfono, correo electrónico, domicilio.</li><li><strong>Datos de salud (categoría especial):</strong> historial clínico, diagnósticos, tratamientos, resultados de estudios de laboratorio e imagen. Estos datos gozan de especial protección conforme al artículo 9 de la LFPDPPP.</li><li><strong>Datos de navegación:</strong> dirección IP, tipo de navegador, páginas visitadas (mediante cookies técnicas y analíticas). Ver sección de Cookies.</li></ul><h3>3. Finalidades del tratamiento</h3><p><strong>Finalidades primarias (necesarias):</strong> prestación de servicios médicos, elaboración de expediente clínico, comunicación para seguimiento de consultas, cumplimiento de obligaciones legales del ejercicio médico.</p><p><strong>Finalidades secundarias (opcionales):</strong> envío de información sobre servicios, recordatorios de citas, mejora de la experiencia en el sitio web.</p><h3>4. Transferencia de datos</h3><p>Sus datos personales no serán transferidos a terceros sin su consentimiento, salvo en los casos previstos por la ley: autoridades de salud, judiciales o administrativas cuando sea legalmente requerido.</p><h3>5. Derechos ARCO</h3><p>Usted tiene derecho a <strong>Acceder, Rectificar, Cancelar u Oponerse</strong> al tratamiento de sus datos (derechos ARCO). Para ejercerlos, envíe una solicitud con identificación oficial a: <strong>contacto@internistaenaguascalientes.com</strong> o al teléfono 449-497-02-40. La Responsable atenderá su solicitud en un plazo máximo de 20 días hábiles.</p><h3>6. Cambios al Aviso de Privacidad</h3><p>La Responsable se reserva el derecho de modificar este aviso. Cualquier cambio será publicado en este sitio web. El uso continuado del sitio implica la aceptación de las modificaciones.</p></div>`);
          } else {
            _push2(`<!---->`);
          }
          if (activeModal.value === "terms") {
            _push2(`<div><p class="text-slate-500 text-xs mb-4">Última actualización: febrero 2026 • Al utilizar este sitio web, usted acepta los presentes Términos y Condiciones.</p><h3>1. Objeto</h3><p>El presente sitio web <strong>internistaenaguascalientes.com</strong> es propiedad de la Dra. Rosalba Yissel Mendoza González y tiene como propósito proporcionar información sobre sus servicios médicos de Medicina Interna en Aguascalientes, México, y facilitar el contacto para agendar consultas.</p><h3>2. Información médica general</h3><p>El contenido de este sitio tiene carácter <strong>informativo y divulgativo</strong>. En ningún caso sustituye la relación médico-paciente, el diagnóstico clínico ni el tratamiento prescrito por un profesional de la salud. Consulte siempre a un especialista ante cualquier duda sobre su estado de salud.</p><h3>3. Propiedad intelectual</h3><p>Todos los textos, imágenes, logotipos, diseños y elementos del presente sitio son propiedad exclusiva de la Dra. Yissel Mendoza o se usan con la debida autorización. Queda prohibida su reproducción total o parcial sin consentimiento escrito previo.</p><h3>4. Uso del sitio</h3><p>El usuario se compromete a utilizar el sitio de forma lícita, sin realizar actividades que puedan dañar, inutilizar o deteriorar el sitio o su reputación. Queda prohibido el uso del sitio para enviar comunicaciones no solicitadas.</p><h3>5. Limitación de responsabilidad</h3><p>La Responsable no garantiza la disponibilidad continua del sitio web y no se hace responsable por daños derivados del uso o imposibilidad de uso del mismo, ni por errores u omisiones en el contenido informativo.</p><h3>6. Citas y servicios médicos</h3><p>La solicitud de cita a través de este sitio o por teléfono no representa un contrato de prestación de servicios médicos. La relación médico-paciente y los honorarios aplicables serán establecidos directamente en el consultorio conforme a la normativa vigente en México.</p><h3>7. Cancelación de citas</h3><p>Se solicita cancelar o reprogramar con un mínimo de <strong>24 horas de anticipación</strong> para permitir la atención de otros pacientes.</p><h3>8. Legislación aplicable</h3><p>Los presentes Términos se rigen por las leyes de los <strong>Estados Unidos Mexicanos</strong>. Para cualquier controversia, ambas partes se someten a la jurisdicción de los tribunales competentes de la ciudad de Aguascalientes.</p></div>`);
          } else {
            _push2(`<!---->`);
          }
          if (activeModal.value === "cookies") {
            _push2(`<div><p class="text-slate-500 text-xs mb-4">Última actualización: febrero 2026</p><h3>¿Qué son las cookies?</h3><p>Las cookies son pequeños archivos de texto que los sitios web almacenan en su dispositivo para recordar preferencias, mejorar la funcionalidad y recopilar información estadística anónima sobre el uso del sitio.</p><h3>Tipos de cookies que utilizamos</h3><ul><li><strong>Cookies técnicas / esenciales:</strong> Necesarias para el funcionamiento básico del sitio (tema visual, preferencias de idioma, seguridad de formularios). No requieren consentimiento.</li><li><strong>Cookies analíticas:</strong> Utilizamos Google Analytics de forma anonimizada para entender cómo los usuarios navegan por el sitio y mejorar el contenido. No identifican a personas físicas.</li><li><strong>Cookies de terceros (Mapas):</strong> El mapa embebido de Google Maps puede establecer cookies propias de Google Inc. Consulte la política de privacidad de Google para más información.</li></ul><h3>¿Cómo administrar las cookies?</h3><p>Puede aceptar o rechazar las cookies no esenciales mediante el banner que aparece al ingresar al sitio, o configurarlas desde los ajustes de su navegador:</p><ul><li><strong>Chrome:</strong> Configuración → Privacidad y seguridad → Cookies</li><li><strong>Firefox:</strong> Opciones → Privacidad y seguridad</li><li><strong>Safari:</strong> Preferencias → Privacidad</li><li><strong>Edge:</strong> Configuración → Privacidad, búsqueda y servicios</li></ul><p>La desactivación de cookies técnicas puede afectar el funcionamiento correcto del sitio.</p><h3>Vigencia</h3><p>Las cookies analíticas se conservan por un máximo de 13 meses. Las cookies técnicas persisten durante la sesión o hasta que el usuario las elimine manualmente.</p></div>`);
          } else {
            _push2(`<!---->`);
          }
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        "aria-label": "Agendar cita por WhatsApp con la Dra. Yissel Mendoza, Médico Internista en Aguascalientes"
...
//# sourceMappingURL=default-DUii-jo2.js.map
