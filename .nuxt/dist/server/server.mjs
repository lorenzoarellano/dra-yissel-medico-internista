import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, unref, version, h, shallowRef, isReadonly, isRef, defineComponent, ref, provide, createElementBlock, isReactive, toRaw, isShallow, defineAsyncComponent, computed, Suspense, nextTick, mergeProps, Transition, watch, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DraqqeI6.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-CPt6RJet.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import("./_nuxt/default-DUii-jo2.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-0sW5O7dn.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BrR63sxk.js").then((r) => r.default || r));
