...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, getResponseStatus, createError, removeResponseHeader, appendResponseHeader, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/devalue/index.js';
import destr from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withoutTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withBase, joinRelativeURL, decodePath, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/ufo/dist/index.mjs';
...
import { createFetch, Headers as Headers$1 } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/errx/dist/index.js';
import { isVNode, toValue, unref, version } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/vue/index.mjs';
import devalue from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, basename, isAbsolute } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/lorenzoarellano/developer/dra-yissel/.nuxt/nuxt-icon-server-bundle.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/lorenzoarellano/developer/dra-yissel/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/lorenzoarellano/developer/dra-yissel/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lorenzoarellano/developer/dra-yissel"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lorenzoarellano/developer/dra-yissel/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lorenzoarellano/developer/dra-yissel/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lorenzoarellano/developer/dra-yissel/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/lorenzoarellano/developer/dra-yissel/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/lorenzoarellano/developer/dra-yissel/public"
      ]
    },
    "http": {
      "domains": []
...
const _Bx8JpvEqOHCRGQpIYQWVH0vAD1uBqSXUcOSRRMeH3RM = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/lorenzoarellano/developer/dra-yissel";
...
const _p0BXkn6Sp10XxAZiG6lKtwwe8gQy3hhC3MS3prONlzc = (nitroApp) => {
...
const _HeD_ADYC7ibS0mI7tu6cGDlXKyD3WD9SaAuSn4IsB4 = defineNitroPlugin(async (nitroApp) => {
...
const _LguajFAejBzQKyoxgeb0DqfICH1P1K33Z58eiN4GSE = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _Bx8JpvEqOHCRGQpIYQWVH0vAD1uBqSXUcOSRRMeH3RM,
_p0BXkn6Sp10XxAZiG6lKtwwe8gQy3hhC3MS3prONlzc,
_HeD_ADYC7ibS0mI7tu6cGDlXKyD3WD9SaAuSn4IsB4,
_LguajFAejBzQKyoxgeb0DqfICH1P1K33Z58eiN4GSE
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"22f13-UZltU05iNVOlN9MYi0lo5cEApck\"",
    "mtime": "2026-02-22T03:33:37.868Z",
    "size": 143123,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"868ce-ckzkEKM/XWlW9gABoAvkaAouOF8\"",
    "mtime": "2026-02-22T03:33:37.868Z",
    "size": 551118,
    "path": "index.mjs.map"
  }
...
const _S5T6yQ = eventHandler((event) => {
...
const _TuJzH8 = defineEventHandler(async (e) => {
...
const _tpVxZR = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _KgRXyV = defineEventHandler(async (e) => {
...
const _gkOV8W = defineEventHandler(async (e) => {
...
const _gd9y_6 = defineEventHandler(async (e) => {
...
const _FBYflX = defineEventHandler(async (e) => {
...
const _5GdB_j = defineEventHandler(async (e) => {
...
const _d3iCB3 = defineEventHandler(async (e) => {
...
const _UFxnRa = defineEventHandler(async (e) => {
...
const _iJuIts = defineCachedEventHandler(async (ctx) => {
...
const _SzFtAn = lazyEventHandler(() => {
...
const _lazy_07_CqC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _S5T6yQ, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_07_CqC, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _TuJzH8, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _tpVxZR, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _KgRXyV, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _gkOV8W, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _gd9y_6, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _FBYflX, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _5GdB_j, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _d3iCB3, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _UFxnRa, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _iJuIts, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _SzFtAn, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_07_CqC, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/lorenzoarellano/developer/dra-yissel/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/lorenzoarellano/developer/dra-yissel/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
